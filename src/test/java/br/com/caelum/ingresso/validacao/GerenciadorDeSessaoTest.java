...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes(){
		...
		this.sessaoDasDezoito = new Sessao(LocalTime.parse("18:00:00"), filme, sala3D);
	}
	@Test
	...
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaSessaoJaExistente(){
		...
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().minusHours(1), filme, sala3D);
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
	...
	public void garanteQueNaoDevePermitirSessoesIniciandoDentroDoHorarioDeUmaSessaoJaExistente(){
		...
		Sessao sessao = new Sessao(sessaoDasDez.getHorario().plusHours(1), filme, sala3D);
		Assert.assertFalse(gerenciador.cabe(sessao));
	}
	@Test
